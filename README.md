...
## * 8주차 수업 *
 - 메인화면 게시판 링크 수정, 블로그 글쓰기 페이지 구현, 저장 기능 추가, 검색창 구현 완료
<p align="center">
...
## * 10주차 수업 *
 - 프로필 팀원 수정 구현, 로그인 세션 유지, 검사 기능, 로그아웃 세션 삭제 구현, 세션 보안 기능 구현 완료
<p align="center">
...
####  ➜ 10주차 응용 문제 & 추가 구현 완료
 - 게시판 작성자를 사용자로 저장 구현, 글쓰기 수정/삭제 버튼 구현 완료
<p align="center">
